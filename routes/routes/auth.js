...
const { Ciudad, Prisma } = require("@prisma/client");
...
router.post("/register", async (req, res) => {
  ...
  try {
    ...
    const safeCiudad = ciudad ?? Ciudad.COCHABAMBA;
...
// ✅ ESTA LÍNEA ES LA MÁS IMPORTANTE - DEBE SER module.exports
